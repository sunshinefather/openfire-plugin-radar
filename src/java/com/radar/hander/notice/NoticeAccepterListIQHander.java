...
public class NoticeAccepterListIQHander extends IQHandler {

	private IQHandlerInfo info;
	private final static String NAME_SPACE = IqConstant.NOTICE_ACCEPTER_LIST;
    private static final Logger log = LoggerFactory.getLogger(NoticeAccepterListIQHander.class);
	public NoticeAccepterListIQHander() {
		super("NoticeAccepterListIQHander");
	...
	public IQ handleIQ(IQ packet) throws UnauthorizedException {
        ...
        if(StringUtils.isEmpty(accepter) || StringUtils.isEmpty(noticeType)){
        	replay.setType(Type.error);
        	log.info("拉取通知列表失败:参数错误");
        	return replay;
        }
        String notice= NoticeAction.findAccepterList(accepter, noticeType, pageNo, pageSize);
